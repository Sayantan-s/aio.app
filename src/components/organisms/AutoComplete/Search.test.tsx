...
describe('Autocomplete', () => {
  test('Should render autocomplete correctly', () => {
    render(<Search placeholder="Bitcoin..." value="" onSearch={() => {}} onSearchClear={() => {}} />);
  ...
  test('Should add close button correctly', () => {
    render(<Search placeholder="Bitcoin..." value="uniswap" onSearch={() => {}} onSearchClear={() => {}} />);
    const closeButton = screen.queryByRole('button');
  ...
  test('Should call the search handler correctly', async () => {
    ...
    render(<Search placeholder="Bitcoin..." value="" onSearch={fnSearch} onSearchClear={() => {}} />);
    const elementInput = screen.getByPlaceholderText(/bitcoin/i);
  ...
  test('Should call the search clear handler correctly', async () => {
    ...
    render(<Search placeholder="Bitcoin..." value={'gmail'} onSearch={() => {}} onSearchClear={fnClearSearch} />);
